      ...
      <div className="w-60 relative">
        ...
        <div className="py-4 px-1.5">
          ...
          <div className="flex justify-between">
            ...
            <p className="text-red-500 text-xs font-semibold line-through">
              750
            </p>
          </div>
        </div>
        <div className="flex justify-between gap-4">
          ...
          <button className="border border-zinc-400 py-1.5 px-7 rounded-full text-zinc-400 hover:bg-red-600 hover:text-white hover:border-red-600">
