                ...
                <div className='p-6 grid xl:grid-cols-12 '>
                    ...
                    <div className='xl:col-span-8'>
                        <div className=' header mb-4'>
                            ...
                            <span className=' blackMuted70'>showing 3 products you added</span>
                        </div>
                        ...
                        <div className='grid grid-cols-12'>
                            <div className=' col-span-8 '>
                                <label className="flex items-center  ">
                                    ...
                                    <div className="bg-black w-6 h-6 rounded-full flex items-center
                                justify-center text-white ">{products.length}</div>
                        ...
                        <div className='repeatedforMAP'>
                            ...
                            <div className='grid grid-cols-12 gap-x-4'>
                                ...
                                <div className="ms-3 col-span-12 lg:col-span-4 xl:col-span-4 text-center self-center justify-center space-y-2
                                xl:text-start
                                lg:text-start
                                md:text-center md:my-4
                                sm:text-center sm:my-4
                                xs:text-center xs:pb-2 ">
                                    <span className='block text-sm blackMuted70'>category name</span>
