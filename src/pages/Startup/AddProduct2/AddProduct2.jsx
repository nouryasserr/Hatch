    ...
    <>
      <div className="w-full lg:w-5/6 float-end px-8 py-6">
        ...
        <form>
          <div className="flex flex-col lg:flex-row justify-between gap-6">
            <div className="w-full lg:w-1/2">
              ...
              <div className="mb-4 mt-8">
                ...
                <p className="text-lightblack text-sm">
                  choose from the sizes and colors you entered
                </p>
              </div>
              <div>
                <div className="flex flex-col sm:flex-row gap-4 mb-4">
                  <div className="w-full">
                    <label
                      ...
                      className="flex items-start gap-2 mb-2"
                    >
                      <span className="text-lg">color name, code</span>
                    </label>
                    <input
                      type="text"
                      autoComplete="on"
                ...
                <div className="mb-4">
                  ...
                  <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-4">
                    {images.map((img, index) => (
                      <div
                        key={index}
                        className="w-full aspect-square border border-blackmuted flex items-center justify-center overflow-hidden bg-gray-100"
                      >
                        {img ? (
                          <>
                            <img
          ...
          <Link
            to={"/Startup/Products"}
            className="w-full lg:w-1/2 block text-center mt-4 underline hover:no-underline transition duration-300 ease-in-out delay-150"
          >
            cancel
          </Link>
        </form>
