    ...
    <>
      <div className="w-full lg:w-5/6 float-end px-8 py-8">
        <div>
          ...
          <p className="text-lightgray pt-0.5 text-sm">
        ...
        <div className="flex flex-col lg:flex-row gap-8 mt-8">
          <div className="lg:w-1/2">
            <div className="mb-4 xs:mb-0">
              <h2 className="text-3xl mb-0.5">users overview</h2>
            ...
            <div className="flex gap-2 mt-4">
              <div className="w-1/2 space-y-4">
                ...
                <Link
                  to={"/Admin/AllUsers"}
                  className="block w-fit text-sm text-white bg-primary px-4 py-1.5 rounded-sm border border-lightblack hover:bg-transparent hover:text-black transition duration-300"
                >
                  manage users
                </Link>
              </div>
          ...
          <div className="lg:w-1/2">
            <div className="mb-4 xs:mb-0">
              <h2 className="text-3xl mb-0.5">categories overview</h2>
              <p className="text-lightgray text-sm">
        ...
        <div className="flex flex-col lg:flex-row gap-8 mt-8 lg:mt-16">
          <div className="lg:w-1/2">
            <div className="mb-4 xs:mb-0">
              <h2 className="text-3xl mb-0.5">startups overview</h2>
              <p className="text-lightgray text-sm">
            ...
            <div className="flex gap-2 mt-4">
              <div className="w-1/2 space-y-4">
                <p className="text-sm xs:text-base">active startups no:</p>
                <p className="text-sm xs:text-base">pending approvals no:</p>
                <p className="text-sm xs:text-base">blocked startups no:</p>
                <Link
          ...
          <div className="lg:w-1/2">
            <div className="mb-4 xs:mb-0">
              <h2 className="text-3xl mb-0.5">factories overview</h2>
              <p className="text-lightgray text-sm">
            ...
            <div className="flex gap-2 mt-4">
              <div className="w-1/2 space-y-4">
                ...
                <p className="text-sm xs:text-base">active factories no:</p>
                <p className="text-sm xs:text-base">blocked factories no:</p>
                <Link
